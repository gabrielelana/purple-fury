...
{"username": "user-006", "password": "secret"}
#+END_SRC

Then we create a room
#+BEGIN_SRC http :pretty :wrap EXAMPLE :var token=login-006
POST http://localhost:4000/rooms
Accept: application/json
Content-Type: application/json

{"token": "${token}", "name": "room-006", "topic": "Nothing interesting"}
#+END_SRC
...
{
  "name": "room-006",
  "topic": "Nothing interesting",
  "isPrivate": false,
  "_id": "2SanfhaICGl3jztT",
  "createdAt": "2018-06-14T09:02:43.741Z",
  "updatedAt": "2018-06-14T09:02:43.741Z"
}
#+END_EXAMPLE

Then post a couple of messages
#+BEGIN_SRC http :pretty :var token=login-006 :results silent
POST http://localhost:4000/messages
Accept: application/json
Content-Type: application/json

{"token": "${token}", "message": "hello world", "room": "room-006"}
#+END_SRC
...
{"token": "${token}", "message": "hello there", "room": "room-006"}
#+END_SRC
...
{"token": "${token}", "message": "greetings", "room": "room-006"}
#+END_SRC

Then we can get all the messages
#+BEGIN_SRC http :pretty :wrap EXAMPLE :var token=login-006
GET http://localhost:4000/messages?token=${token}
Accept: application/json
Content-Type: application/json
  ...
  "messages": [
    {
      ...
      "message": "hello world",
      "room": "room-006",
      "_id": "sNzMtFxGa7ypsSDk",
      "createdAt": "2018-06-14T09:02:47.360Z",
      "updatedAt": "2018-06-14T09:02:47.360Z"
    },
    {
      "username": "user-006",
      "message": "hello there",
      "room": "room-006",
      "_id": "YwlvICLS8xCEWqWa",
      "createdAt": "2018-06-14T09:02:49.189Z",
      "updatedAt": "2018-06-14T09:02:49.189Z"
    },
    {
      "username": "user-006",
      "message": "greetings",
      "room": "room-006",
      "_id": "u6WrcF41eMiBEoR5",
      "createdAt": "2018-06-14T09:02:53.180Z",
      "updatedAt": "2018-06-14T09:02:53.180Z"
    }
  ]
}
#+END_EXAMPLE

All messages that contains the world ~hello~
#+BEGIN_SRC http :pretty :wrap EXAMPLE :var token=login-006
GET http://localhost:4000/messages?search=hello&token=${token}
Accept: application/json
Content-Type: application/json
#+END_SRC
...
All messages that contains the world ~hello~ and ~world~
#+BEGIN_SRC http :pretty :wrap EXAMPLE :var token=login-006
GET http://localhost:4000/messages?search=hello%2Bworld&token=${token}
Accept: application/json
Content-Type: application/json
#+END_SRC
...
All messages that contains the world ~greetings~
#+BEGIN_SRC http :pretty :wrap EXAMPLE :var token=login-006
GET http://localhost:4000/messages?search=greetings&token=${token}
Accept: application/json
Content-Type: application/json
#+END_SRC
...
Restricting the search to a single room
#+BEGIN_SRC http :pretty :wrap EXAMPLE :var token=login-006
GET http://localhost:4000/rooms/room-006/messages?search=greetings&token=${token}
Accept: application/json
Content-Type: application/json
#+END_SRC
